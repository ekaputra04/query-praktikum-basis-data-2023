...
create table review(
  ...
  updated_at timestamp default current_timestamp on update current_timestamp,
  foreign key(id_user) references users(id),
  foreign key(id_pesanan_lapangan) references penyewaan_lapangan(id),
  foreign key(id_pesanan_raket) references penyewaan_raket(id)
);